...
* **Screenshot:**
    ![Node.js version output](screenshots/image.png)
...
* **Command:** `git --version`
* **Screenshot:**
    ![Git version output](screenshots/image-1.png)
...
* **Screenshot:**
    ![VS Code Insider with GitHub Copilot](screenshots/image-2.png)
...
* **Screenshot:**
![Claude Desktop — main window](screenshots/image-3.png)
![Claude Desktop — MCP connection status (1)](screenshots/image-4.png)
![Claude Desktop — MCP connection status (2)](screenshots/image-5.png)
---
